...
os.system('sudo pacman -S acpilight alacritty awesome dmenu fish git lxappearance mpv qt5ct qtile ranger tk ttf-hack ttf-ubuntu-font-family vim xbindkeys')
